...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const testAnxiety = await res.json();

  document.getElementById("title").textContent = testAnxiety.title;
  document.getElementById("description").textContent = testAnxiety.description;

  const container = document.getElementById("question-container");

  testAnxiety.questions.forEach((q, index) => {
